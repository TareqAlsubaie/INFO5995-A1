...
public abstract class AbstractLongTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class LongTimeMark implements ComparableTimeMark {
        ...
        public long mo1465minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (other instanceof LongTimeMark) {
                ...
                if (Intrinsics.areEqual(this.timeSource, longTimeMark.timeSource)) {
                    ...
                    long jM1509minusLRDsOJo = Duration.m1509minusLRDsOJo(this.offset, longTimeMark.offset);
        ...
        public final long m1467effectiveDurationUwyO8pc$kotlin_stdlib() {
            ...
            long j4 = this.offset;
            long jM1495getInWholeSecondsimpl = Duration.m1495getInWholeSecondsimpl(j4);
            int iM1497getNanosecondsComponentimpl = Duration.m1497getNanosecondsComponentimpl(j4);
            int i = iM1497getNanosecondsComponentimpl / DurationKt.NANOS_IN_MILLIS;
            int i2 = iM1497getNanosecondsComponentimpl % DurationKt.NANOS_IN_MILLIS;
            long duration = DurationKt.toDuration(j3, unit);
            Duration.Companion companion = Duration.INSTANCE;
            long jM1510plusLRDsOJo = Duration.m1510plusLRDsOJo(duration, DurationKt.toDuration(i2, DurationUnit.NANOSECONDS));
            Duration.Companion companion2 = Duration.INSTANCE;
            long jM1510plusLRDsOJo2 = Duration.m1510plusLRDsOJo(jM1510plusLRDsOJo, DurationKt.toDuration(j2 + i, DurationUnit.MILLISECONDS));
            Duration.Companion companion3 = Duration.INSTANCE;
            return Duration.m1510plusLRDsOJo(jM1510plusLRDsOJo2, DurationKt.toDuration(jM1495getInWholeSecondsimpl, DurationUnit.SECONDS));
        }
