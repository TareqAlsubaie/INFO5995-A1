...
public final class Duration implements Comparable<Duration> {
    ...
    public static final class Companion {
        ...
        public final Duration m1595parseOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1472boximpl(DurationKt.parseDuration(value, false));
        ...
        public final Duration m1594parseIsoStringOrNullFghU774(String value) {
            Intrinsics.checkNotNullParameter(value, "value");
            try {
                return Duration.m1472boximpl(DurationKt.parseDuration(value, true));
            } catch (IllegalArgumentException unused) {
                return null;
            }
        }
    ...
    public static final long m1526unaryMinusUwyO8pc(long j) {
        return DurationKt.durationOf(-m1501getValueimpl(j), ((int) j) & 1);
    }
    ...
    public static final long m1510plusLRDsOJo(long j, long j2) {
        ...
        if ((((int) j) & 1) == (((int) j2) & 1)) {
            long jM1501getValueimpl = m1501getValueimpl(j) + m1501getValueimpl(j2);
            return m1505isInNanosimpl(j) ? DurationKt.durationOfNanosNormalized(jM1501getValueimpl) : DurationKt.durationOfMillisNormalized(jM1501getValueimpl);
        }
    ...
    public static final long m1512timesUwyO8pc(long j, int i) {
        ...
        long jM1501getValueimpl = m1501getValueimpl(j);
        long j2 = i;
        long j3 = jM1501getValueimpl * j2;
        if (!m1505isInNanosimpl(j)) {
            if (j3 / j2 == jM1501getValueimpl) {
                return DurationKt.durationOfMillis(RangesKt.coerceIn(j3, new LongRange(-4611686018427387903L, DurationKt.MAX_MILLIS)));
            }
            return MathKt.getSign(jM1501getValueimpl) * MathKt.getSign(i) > 0 ? INFINITE : NEG_INFINITE;
        }
        if (new LongRange(-2147483647L, 2147483647L).contains(jM1501getValueimpl)) {
            return DurationKt.durationOfNanos(j3);
        }
        if (j3 / j2 == jM1501getValueimpl) {
            return DurationKt.durationOfNanosNormalized(j3);
        }
        long jNanosToMillis = DurationKt.nanosToMillis(jM1501getValueimpl);
        long j4 = jNanosToMillis * j2;
        long jNanosToMillis2 = DurationKt.nanosToMillis((jM1501getValueimpl - DurationKt.millisToNanos(jNanosToMillis)) * j2) + j4;
    ...
    public static final long m1511timesUwyO8pc(long j, double d) {
        ...
        if (((double) iRoundToInt) == d) {
            return m1512timesUwyO8pc(j, iRoundToInt);
        }
        DurationUnit durationUnitM1499getStorageUnitimpl = m1499getStorageUnitimpl(j);
        return DurationKt.toDuration(m1517toDoubleimpl(j, durationUnitM1499getStorageUnitimpl) * d, durationUnitM1499getStorageUnitimpl);
    }
    ...
    public static final long m1477divUwyO8pc(long j, int i) {
        ...
        if (m1505isInNanosimpl(j)) {
            return DurationKt.durationOfNanos(m1501getValueimpl(j) / i);
        }
        if (m1506isInfiniteimpl(j)) {
            return m1512timesUwyO8pc(j, MathKt.getSign(i));
        }
        long j2 = i;
        long jM1501getValueimpl = m1501getValueimpl(j) / j2;
        if (new LongRange(-4611686018426L, 4611686018426L).contains(jM1501getValueimpl)) {
            return DurationKt.durationOfNanos(DurationKt.millisToNanos(jM1501getValueimpl) + (DurationKt.millisToNanos(m1501getValueimpl(j) - (jM1501getValueimpl * j2)) / j2));
        }
        return DurationKt.durationOfMillis(jM1501getValueimpl);
    }
    ...
    public static final long m1476divUwyO8pc(long j, double d) {
        ...
        if ((((double) iRoundToInt) == d) && iRoundToInt != 0) {
            return m1477divUwyO8pc(j, iRoundToInt);
        }
        DurationUnit durationUnitM1499getStorageUnitimpl = m1499getStorageUnitimpl(j);
        return DurationKt.toDuration(m1517toDoubleimpl(j, durationUnitM1499getStorageUnitimpl) / d, durationUnitM1499getStorageUnitimpl);
    }
    ...
    public static final int m1497getNanosecondsComponentimpl(long j) {
        long jM1501getValueimpl;
        if (m1506isInfiniteimpl(j)) {
            return 0;
        }
        if (m1504isInMillisimpl(j)) {
            jM1501getValueimpl = DurationKt.millisToNanos(m1501getValueimpl(j) % 1000);
        } else {
            jM1501getValueimpl = m1501getValueimpl(j) % 1000000000;
        }
        return (int) jM1501getValueimpl;
    }
    ...
    public static final long m1494getInWholeNanosecondsimpl(long j) {
        long jM1501getValueimpl = m1501getValueimpl(j);
        if (m1505isInNanosimpl(j)) {
            return jM1501getValueimpl;
        }
        if (jM1501getValueimpl > 9223372036854L) {
            return Long.MAX_VALUE;
        }
        if (jM1501getValueimpl < -9223372036854L) {
            return Long.MIN_VALUE;
        }
        return DurationKt.millisToNanos(jM1501getValueimpl);
    }
    ...
    public static String m1523toStringimpl(long j) {
        ...
        boolean zM1507isNegativeimpl = m1507isNegativeimpl(j);
        StringBuilder sb = new StringBuilder();
        if (zM1507isNegativeimpl) {
            sb.append('-');
        }
        long jM1480getAbsoluteValueUwyO8pc = m1480getAbsoluteValueUwyO8pc(j);
        long jM1489getInWholeDaysimpl = m1489getInWholeDaysimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1481getHoursComponentimpl = m1481getHoursComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1496getMinutesComponentimpl = m1496getMinutesComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1498getSecondsComponentimpl = m1498getSecondsComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1497getNanosecondsComponentimpl = m1497getNanosecondsComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int i = 0;
        boolean z = jM1489getInWholeDaysimpl != 0;
        boolean z2 = iM1481getHoursComponentimpl != 0;
        boolean z3 = iM1496getMinutesComponentimpl != 0;
        boolean z4 = (iM1498getSecondsComponentimpl == 0 && iM1497getNanosecondsComponentimpl == 0) ? false : true;
        if (z) {
            sb.append(jM1489getInWholeDaysimpl).append('d');
            i = 1;
        }
        if (z2 || (z && (z3 || z4))) {
            int i2 = i + 1;
            ...
            sb.append(iM1481getHoursComponentimpl).append('h');
            i = i2;
        }
        if (z3 || (z4 && (z2 || z))) {
            int i3 = i + 1;
            ...
            sb.append(iM1496getMinutesComponentimpl).append('m');
            i = i3;
        }
        if (z4) {
            int i4 = i + 1;
            ...
            if (iM1498getSecondsComponentimpl != 0 || z || z2 || z3) {
                m1471appendFractionalimpl(j, sb, iM1498getSecondsComponentimpl, iM1497getNanosecondsComponentimpl, 9, "s", false);
            } else if (iM1497getNanosecondsComponentimpl >= 1000000) {
                m1471appendFractionalimpl(j, sb, iM1497getNanosecondsComponentimpl / DurationKt.NANOS_IN_MILLIS, iM1497getNanosecondsComponentimpl % DurationKt.NANOS_IN_MILLIS, 6, "ms", false);
            } else if (iM1497getNanosecondsComponentimpl >= 1000) {
                m1471appendFractionalimpl(j, sb, iM1497getNanosecondsComponentimpl / 1000, iM1497getNanosecondsComponentimpl % 1000, 3, "us", false);
            } else {
                sb.append(iM1497getNanosecondsComponentimpl).append("ns");
            }
            i = i4;
        }
        if (zM1507isNegativeimpl && i > 1) {
            sb.insert(1, '(').append(')');
        }
    ...
    public static final String m1524toStringimpl(long j, DurationUnit unit, int i) {
        ...
        double dM1517toDoubleimpl = m1517toDoubleimpl(j, unit);
        return Double.isInfinite(dM1517toDoubleimpl) ? String.valueOf(dM1517toDoubleimpl) : DurationJvmKt.formatToExactDecimals(dM1517toDoubleimpl, RangesKt.coerceAtMost(i, 12)) + DurationUnitKt.shortName(unit);
    }
    ...
    public static final String m1519toIsoStringimpl(long j) {
        ...
        sb.append("PT");
        long jM1480getAbsoluteValueUwyO8pc = m1480getAbsoluteValueUwyO8pc(j);
        long jM1490getInWholeHoursimpl = m1490getInWholeHoursimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1496getMinutesComponentimpl = m1496getMinutesComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1498getSecondsComponentimpl = m1498getSecondsComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        int iM1497getNanosecondsComponentimpl = m1497getNanosecondsComponentimpl(jM1480getAbsoluteValueUwyO8pc);
        if (m1506isInfiniteimpl(j)) {
            jM1490getInWholeHoursimpl = 9999999999999L;
        }
        boolean z = true;
        boolean z2 = jM1490getInWholeHoursimpl != 0;
        boolean z3 = (iM1498getSecondsComponentimpl == 0 && iM1497getNanosecondsComponentimpl == 0) ? false : true;
        if (iM1496getMinutesComponentimpl == 0 && (!z3 || !z2)) {
            z = false;
        }
        if (z2) {
            sb.append(jM1490getInWholeHoursimpl).append('H');
        }
        if (z) {
            sb.append(iM1496getMinutesComponentimpl).append('M');
        }
        if (z3 || (!z2 && !z)) {
            m1471appendFractionalimpl(j, sb, iM1498getSecondsComponentimpl, iM1497getNanosecondsComponentimpl, 9, "S", true);
        }
        String string = sb.toString();
        Intrinsics.checkNotNullExpressionValue(string, "StringBuilder().apply(builderAction).toString()");
        return string;
