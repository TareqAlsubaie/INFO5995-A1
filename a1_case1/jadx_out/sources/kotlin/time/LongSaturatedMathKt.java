...
public final class LongSaturatedMathKt {
    ...
    public static final long m1602saturatingAddpTJri5U(long j, long j2) {
        long jM1494getInWholeNanosecondsimpl = Duration.m1494getInWholeNanosecondsimpl(j2);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m1601checkInfiniteSumDefinedPjuGub4(j, j2, jM1494getInWholeNanosecondsimpl);
        }
        if ((1 | (jM1494getInWholeNanosecondsimpl - 1)) == Long.MAX_VALUE) {
            return m1603saturatingAddInHalvespTJri5U(j, j2);
        }
        long j3 = j + jM1494getInWholeNanosecondsimpl;
        return ((j ^ j3) & (jM1494getInWholeNanosecondsimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }
    ...
    private static final long m1603saturatingAddInHalvespTJri5U(long j, long j2) {
        long jM1477divUwyO8pc = Duration.m1477divUwyO8pc(j2, 2);
        if (((Duration.m1494getInWholeNanosecondsimpl(jM1477divUwyO8pc) - 1) | 1) == Long.MAX_VALUE) {
            return (long) (j + Duration.m1517toDoubleimpl(j2, DurationUnit.NANOSECONDS));
        }
        return m1602saturatingAddpTJri5U(m1602saturatingAddpTJri5U(j, jM1477divUwyO8pc), Duration.m1509minusLRDsOJo(j2, jM1477divUwyO8pc));
    }
