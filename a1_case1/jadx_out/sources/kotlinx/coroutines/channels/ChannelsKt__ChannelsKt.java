...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            try {
                ...
                objM147constructorimpl = Result.m147constructorimpl(Unit.INSTANCE);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM147constructorimpl = Result.m147constructorimpl(ResultKt.createFailure(th));
            }
            return ChannelResult.m1660boximpl(Result.m154isSuccessimpl(objM147constructorimpl) ? ChannelResult.INSTANCE.m1675successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m1673closedJP2dKIU(Result.m150exceptionOrNullimpl(objM147constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo1655trySendJP2dKIU = sendChannel.mo1655trySendJP2dKIU(e);
        if (objMo1655trySendJP2dKIU instanceof ChannelResult.Failed) {
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1670isSuccessimpl(sendChannel.mo1655trySendJP2dKIU(e))) {
            return;
        }
