...
public interface SendChannel<E> {
    ...
    Object mo1655trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m1670isSuccessimpl(objMo1655trySendJP2dKIU)) {
                return true;
            }
            Throwable thM1664exceptionOrNullimpl = ChannelResult.m1664exceptionOrNullimpl(objMo1655trySendJP2dKIU);
