...
public interface ReceiveChannel<E> {
    ...
    Object mo1653receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1654tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1654tryReceivePtdJZtk = receiveChannel.mo1654tryReceivePtdJZtk();
            if (ChannelResult.m1670isSuccessimpl(objMo1654tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1666getOrThrowimpl(objMo1654tryReceivePtdJZtk);
            }
            Throwable thM1664exceptionOrNullimpl = ChannelResult.m1664exceptionOrNullimpl(objMo1654tryReceivePtdJZtk);
            if (thM1664exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1664exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) throws java.lang.Throwable {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo1653receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
