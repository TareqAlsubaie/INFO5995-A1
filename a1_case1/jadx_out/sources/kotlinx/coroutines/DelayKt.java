...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1701scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1637delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m1638toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1638toDelayMillisLRDsOJo(long j) {
        if (Duration.m1473compareToLRDsOJo(j, Duration.INSTANCE.m1576getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1492getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
