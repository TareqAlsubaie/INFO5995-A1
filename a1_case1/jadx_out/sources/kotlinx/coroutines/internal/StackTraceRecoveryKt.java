...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM147constructorimpl2;
        Object obj = stackTraceRecoveryClass;
        Object obj2 = baseContinuationImplClass;
        try {
            Result.Companion companion = Result.INSTANCE;
            objM147constructorimpl = Result.m147constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM147constructorimpl = Result.m147constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m150exceptionOrNullimpl(objM147constructorimpl) == null) {
            obj2 = objM147constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM147constructorimpl2 = Result.m147constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM147constructorimpl2 = Result.m147constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m150exceptionOrNullimpl(objM147constructorimpl2) == null) {
            obj = objM147constructorimpl2;
        }
