...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM147constructorimpl = Result.m147constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM147constructorimpl = Result.m147constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m153isFailureimpl(objM147constructorimpl) ? null : objM147constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1677installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1677installSignalHandler$lambda1(Signal signal) {
