...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo48clone = transition.mo48clone();
        transitionMo48clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo48clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo48clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo48clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo48clone = transition.mo48clone();
        sceneChangeSetup(viewGroup, transitionMo48clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo48clone);
    }
