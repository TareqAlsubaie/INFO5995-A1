    ...
    private static List<KeylineState> getStateStepsStart(Carousel carousel, KeylineState keylineState) {
        ...
        if (!isFirstFocalItemAtLeftOfContainer(keylineState) && iFindFirstNonAnchorKeylineIndex != -1) {
            ...
            while (i < firstFocalKeylineIndex) {
                ...
                arrayList.add(moveKeylineAndCreateKeylineState(keylineState2, iFindFirstNonAnchorKeylineIndex, i2 - 1 >= 0 ? findFirstIndexAfterLastFocalKeylineWithMask(keylineState2, keylineState.getKeylines().get(r3).mask) - 1 : size, f + f3, (keylineState.getFirstFocalKeylineIndex() - i) - 1, (keylineState.getLastFocalKeylineIndex() - i) - 1, containerWidth));
                i++;
                f2 = f3;
            }
        }
