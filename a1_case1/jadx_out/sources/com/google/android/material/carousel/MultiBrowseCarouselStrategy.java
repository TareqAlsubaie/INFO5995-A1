...
public final class MultiBrowseCarouselStrategy extends CarouselStrategy {
    ...
    KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        Arrangement arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(containerHeight, fClamp, smallSizeMin, smallSizeMax, iArr, f3, iArr2, fMin, iArr3);
        ...
        if (ensureArrangementFitsItemCount(arrangementFindLowestCostArrangement, carousel.getItemCount())) {
            arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(containerHeight, fClamp, smallSizeMin, smallSizeMax, new int[]{arrangementFindLowestCostArrangement.smallCount}, f3, new int[]{arrangementFindLowestCostArrangement.mediumCount}, fMin, new int[]{arrangementFindLowestCostArrangement.largeCount});
        }
