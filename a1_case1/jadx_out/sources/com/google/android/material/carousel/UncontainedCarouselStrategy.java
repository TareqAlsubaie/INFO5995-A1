...
public final class UncontainedCarouselStrategy extends CarouselStrategy {
    ...
    KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        if (carousel.getCarouselAlignment() == 1) {
            float f6 = f5 / 2.0f;
            return createCenterAlignedKeylineState(containerWidth, f, f4, iMax, Math.max(Math.min(3.0f * f6, f4), CarouselStrategyHelper.getSmallSizeMin(view.getContext()) + f), extraSmallSize2, f6);
        }
