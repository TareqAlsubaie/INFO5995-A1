...
public class HeroCarouselStrategy extends CarouselStrategy {
    ...
    KeylineState onFirstChildMeasuredWithMargins(Carousel carousel, View view) {
        ...
        int iMax = (int) Math.max(1.0d, Math.floor((f2 - (CarouselStrategyHelper.maxValue(r4) * smallSizeMax)) / fMin));
        ...
        Arrangement arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(f2, fClamp, smallSizeMin, smallSizeMax, iArrDoubleCounts2, f3, iArrDoubleCounts, fMin, iArr2);
        ...
        if (arrangementFindLowestCostArrangement.getItemCount() > carousel.getItemCount()) {
            arrangementFindLowestCostArrangement = Arrangement.findLowestCostArrangement(f2, fClamp, smallSizeMin, smallSizeMax, iArr, f3, MEDIUM_COUNTS, fMin, iArr2);
            i = 0;
        } else {
            i = i3;
        }
